...
| `tests/unit/test_notifier.py` | Mock SMS/email dispatch; correct message template per event type; notification firedon terminal states only |
...
| `tests/e2e/test_scenarios.py` | 10 defined E2E test scenarios (see Verification Plan below) |
